...
export default function Gallery() {
  ...
  const galleryUrl = typeof window !== 'undefined'
    ? `${window.location.origin}${window.location.pathname}#gallery`
    : '';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {filteredImages.map((img, index) => (
            ...
            >
              ...
              >
                <div className={`overflow-hidden rounded-2xl ${index === 0 ? 'aspect-square sm:aspect-auto sm:h-full' : 'aspect-[4/3]'}`}>
                  <img
                    src={img.url}
                    alt={img.alt}
